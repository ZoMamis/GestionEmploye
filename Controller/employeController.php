<?php
    ...
    switch ($action) {
        ...
        case "modifier":
                ...
                $id = $_GET['id'];
                $dataMod = $db->getData("SELECT * FROM employe WHERE id_employe='$id'");
                // foreach ($db->getData("SELECT * FROM employe WHERE id='$id'") as $row){
                //     $nom_employe = $row['nom_employe'];
                //     $prenom_employe = $row['prenom_employe'];
                // }
                    ...
                    # logique...
                        $nom_employe = $_POST['nom_employe'];
                            ...
                            if (empty($nom_employe) || empty($prenom_employe)) {
                                ...
                                $db->action("UPDATE employe SET nom_employe= '$nom_employe', prenom_employe= '$prenom_employe' WHERE id_employe= $id");
                                header("Location:index.php?Controller=employe");
                            }
                    break;
